...
- `database.sslmode`, `plugin.name`, `slot.name`, `slot.failover`, `publication.name`, `publication.autocreate.mode`, `replica.identity.autoset.values`, `publish.via.partition.root`
