...
mod tests {
    ...
    #[test]
    fn matches_avro_schema_golden_fixtures_for_prioritized_connectors() {
    ...
    #[test]
    #[ignore = "regenerates checked-in Avro schema golden fixtures"]
    fn regenerate_avro_schema_golden_fixtures() {
