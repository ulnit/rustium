...
Rustium 的 PostgreSQL `pgoutput` CDC source，支持 exported snapshot 切换、PostgreSQL 17 failover slot、持久 schema history、WAL 恢复、Debezium interval mode、事务内及非事务 logical decoding message、核心及扩展类型值、heartbeat、信号和增量快照。
