...
1. Close PostgreSQL transient-metadata, live WAL-retention invalidation, optional live PostGIS/pgvector, and real-broker Kafka recovery gates.
...
1. 补齐 PostgreSQL 短暂元数据、真实 WAL retention invalidation、可选 PostGIS/pgvector 实测和真实 broker Kafka 恢复门槛。
